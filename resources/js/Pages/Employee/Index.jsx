                    ...
                    <div className="flex justify-center mb-6">
                        <form onSubmit={handleSearch} className="flex w-full max-w-2xl">
                            <input
                                ...
                                className="block w-full rounded-lg bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-green-300 placeholder:text-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 mr-6"
                            />
                            <button type="submit" className="block rounded-xl bg-grey-300-600 px-3.5 py-2.5 text-center text-sm font-semibold text-green-700 shadow-sm hover:text-white hover:bg-yellow-600 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-indigo-600 border border-green-600">
                                Search
                            </button>
                        </form>
                    </div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200 ">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {sortedEmployees.map((employee) => (
                                    <tr key={employee.emp_no} className='hover:bg-yellow-100'>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">{employee.emp_no}</td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {employee.img && <img src={`/employee_images/${employee.img}`} className="w-10 h-10 rounded-full" />}
                                        </td>
                                    </tr>
                                ))}         
                            </tbody>
